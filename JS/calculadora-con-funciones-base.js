...
let numero2 = pedirAlUsuarioUnNumero(); // Repetimos la misma funcion!

let resultado; // La declaramos fuera de cada "if", 
              // porque su scope debe ser global, y no finalizar cuando finalice el "if"

if (operacion == "+") {
    resultado = sumar(+numero1, +numero2); // Acá hacemos la operacion que transforma el string en numero, asi hacemos 1+1= 2 y no '1'+'1'= 11
}
